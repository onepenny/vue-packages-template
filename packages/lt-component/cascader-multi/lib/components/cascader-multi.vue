<template>
  <div :class="classes" v-clickoutside="handleClose">
    ...
    <transition name="slide-up">
      <div
        class="ivu-select-dropdown cascader-multi"
        v-show="visible"
      ...
      >
        <div>
          <cas-multi-panel
            ...
            :value="queryItem"
            v-if="data.length && (!filterable || query === '')"
            @handleGetSelected="selectedData"
...
import { getSelections, getSelectItem } from '../utils';
